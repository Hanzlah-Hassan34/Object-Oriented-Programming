...
// 	}
// }
// void ReadImage(const string& imgname, unsigned char*& imgArray, int& width, int& height) {
//     using namespace cimg_library;
//     CImg<unsigned char> img(imgname.c_str());
//     width = img.width();
//     height = img.height();

//     // Allocate memory for imgArray
//     imgArray = new unsigned char[width * height * 3];
//     int k = 0;
//     unsigned char *rp = img.data();
//     unsigned char *gp = img.data() + height * width;
//     unsigned char *bp = gp + height * width;

//     for (int j = 0; j < width; ++j) {
//         int t = j;
//         for (int i = 0; i < height; ++i, t += width) {
//             imgArray[k++] = rp[t];
//             imgArray[k++] = gp[t];
//             imgArray[k++] = bp[t];
//         }
